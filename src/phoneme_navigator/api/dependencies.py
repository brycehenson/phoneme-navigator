...
def get_kokoro_client(settings: Settings = get_settings()) -> KokoroClient:
...
def get_phonemize_service() -> PhonemizeService:
...
def get_synthesis_service() -> SynthesisService:
    ...
    return SynthesisService(kokoro_client=get_kokoro_client())
